    ...
    <SafeAreaView style={globalStyles.container} edges={['right', 'bottom', 'left']}>
      <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingTop: 4, paddingBottom: 20 }}>
        ...
        <View style={globalStyles.card}>
          ...
          >
            <Text style={globalStyles.buttonText}>Calculate Category & Price</Text>
          </TouchableOpacity>
        </View>
            ...
            <View style={[globalStyles.card, {
              ...
              <View style={{ alignItems: 'center', marginBottom: 16 }}>
                ...
                <Text style={{ fontSize: 18, fontWeight: 'bold', color: catColor, marginTop: 10 }}>
                  Category {result.category} Player
                </Text>
              ...
              <View style={{ borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 14 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 }}>
                  <Text style={{ color: colors.textLight, fontSize: 13 }}>Base Price (Category {result.category})</Text>
